...
[release]: https://github.com/barnettZQG/gotty/releases
[wercker]: https://app.wercker.com/project/bykey/03b91f441bebeda34f80e09a9f14126f
[license]: https://github.com/barnettZQG/gotty/blob/master/LICENSE
...
Download the latest stable binary file from the [Releases](https://github.com/barnettZQG/gotty/releases) page. Note that the release marked `Pre-release` is built for testing purpose, which can include unstable or breaking changes. Download a release marked [Latest release](https://github.com/barnettZQG/gotty/releases/latest) for a stabale build.
...
```sh
$ go get github.com/barnettZQG/gotty
```
...
See the [`.gotty`](https://github.com/barnettZQG/gotty/blob/master/.gotty) file in this repository for the list of configuration options.
